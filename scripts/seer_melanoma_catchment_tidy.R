...
# {Site and Morphology.Cause of death recode} = '      Melanoma of the Skin'
...
mela_mort <- read_delim("data/raw/seer_stat/mortality_melanoma_catchment_2015-2019_by_race.txt",
                        delim = ",",
                        col_names = c(
                          "race",
                          "sex",
...
mela_mort %>%
  ...
  labs(title = "Melanoma of the Skin Mortality in the UA Catchment",
...
ggsave("figures/charts/uazcc_melanoma_mortality_2015-2019_by_race.png",
       width = 16,
       height = 9)
