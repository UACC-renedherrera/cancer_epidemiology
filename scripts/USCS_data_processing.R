...
by_az_county %>%
  ...
  kable(caption = "For southern arizona only, Crude Incidence Rates by Cancer Site, Years 2012-2016, All Races and Sexes Combined",
...
by_az_county %>%
  ...
  kable(caption = "Crude Rates by Race for Arizona; Year 2012-2016",
...
by_az_county %>%
  ...
  labs(title = "Age Adjusted Mortality Rates",
...
by_az_county %>%
  ...
  kable(caption = "Age adjusted mortality rates by Arizona county for years 2012-2016; grouped by sex, all races and cancer sites combined",
...
by_az_county %>%
  ...
  kable(caption = "Age adjusted mortality rates by Arizona county for years 2012-2016; all sexes, races",
...
by_az_county %>%
  ...
  slice(1:5) %>%
  select(AREA, SEX, SITE, AGE_ADJUSTED_RATE, AGE_ADJUSTED_CI_LOWER, AGE_ADJUSTED_CI_UPPER) %>%
  kable(caption = "Age adjusted mortality rates by Arizona county for years 2012-2016; all sexes, Hispanic only",
        col.names = c("County", "Sex", "Cancer", "Age Adjusted Rate", "95% Confidence Interval LL", "95% Confidence Interval UL"))
